  ...
  return (
    ...
    {/* Top Section */}
      <div className="top">
        <div className="left">
          <h1>
          Empowering Minds, Inspiring Futures: <br />Your Gateway to Online Learning with <span className="font-semibold text-amber-400 font-serif text-5xl">PlaceOmeter</span>
          </h1>
          {/*  Search  */}
          ...
          <div className="search mb-10">
            ...
            <input type="text" placeholder='Ex: Software Engineering ...' value={subject} onChange={(e)=>setSubject(e.target.value)}/>
      ...
      <div className="subjects">
        ...
        <div className="subject" onClick={()=>teachersList("Android Dev")}>
          <img src="https://www.figma.com/file/6b4R8evBkii6mI53IA4vSS/image/3e546b344774eb0235acc6bf6dad7814a59d6e95" alt="Android Dev" />
          <p>Android Dev</p>
        </div>
        <div className="subject" onClick={()=>teachersList("UI")}>
          <img src="https://www.figma.com/file/6b4R8evBkii6mI53IA4vSS/image/28ac70002ae0a676d9cfb0f298f3e453d12b5555" alt="Zoology" />
          <p>UI</p>
        </div>
        <div className="subject" onClick={()=>teachersList("Software Engineering")}>
          <img src="https://www.figma.com/file/6b4R8evBkii6mI53IA4vSS/image/61930117e428a1f0f7268f888a84145f93aa0664" alt="Software Engineering" />
      ...
      <div className="about" style={{backgroundColor: "#042439"}}>
        ...
        <div className="content">
          ...
          <p>
            At PlaceOmeter, we believe in the power of education to transform lives. Our platform is designed to be a gateway to knowledge, offering a diverse range of courses and learning experiences for students.
            <h1 className=" bg-blue-700 w-fit py-1 px-3 rounded-sm my-2">Our Story</h1>
            PlaceOmeter was born out of a passion for learning and a desire to make quality education accessible to everyone. We understand the challenges faced by modern learners and strive to provide a solution that is both convenient and effective.
